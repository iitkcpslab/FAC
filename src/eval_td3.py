...
def evaluate(modelid):
    ...
    for sed in range(0,tseeds):
        ...
        cc = np.array([])
        if modelid=="Pendulum-v1":
            model = TD3.load("td3_Pendulum-v1")
            nsteps=1000 
        elif modelid=="MountainCarContinuous-v0":
            model = TD3.load("td3_MountainCarContinuous-v0")
            nsteps=1000 
        elif modelid=="HalfCheetah-v3":
            model = TD3.load("td3_HalfCheetah-v3")
            nsteps=1000 
        elif modelid=="Hopper-v3":
            model = TD3.load("td3_Hopper-v3")
            nsteps=1000 
        elif modelid=="Ant-v3":
            model = TD3.load("td3_Ant-v3")
            nsteps=1000 
        elif modelid=="Walker2d-v3":
            model = TD3.load("td3_Walker2d-v3")
            nsteps=1000
        elif modelid=="Swimmer-v3":
            model = TD3.load("td3_Swimmer-v3")
            nsteps=1000
        elif modelid=="Humanoid-v3":
            model = TD3.load("td3_Humanoid-v3")
            nsteps=1000
        elif modelid=="ReacherBulletEnv-v0":
            model = TD3.load("td3_ReacherBulletEnv-v0")
            nsteps=150
        elif modelid=="LunarLanderContinuous-v2":
            model = TD3.load("td3_LunarLanderContinuous-v2")
            nsteps=1000
        elif modelid=="BipedalWalker-v3":
            model = TD3.load("td3_BipedalWalker-v3")
            nsteps=1000
        elif modelid=="BipedalWalkerHardcore-v3":
            model = TD3.load("td3_BipedalWalkerHardcore-v3")
            nsteps=1000
        #env.render()
