...
from stable_baselines3.common.buffers_2 import PrioritizedReplayBuffer
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def load_replay_buffer(self, path: Union[str, pathlib.Path, io.BufferedIOBase]) -> None:
        ...
        assert isinstance(self.replay_buffer, PrioritizedReplayBuffer), "The replay buffer must inherit from ReplayBuffer class"
