...
from stable_baselines3.common.off_policy_algorithm_3 import OffPolicyAlgorithm
...
class SAC_LABER(OffPolicyAlgorithm):
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(SAC_LABER, self)._excluded_save_params() + ["actor", "critic", "critic_target"]
