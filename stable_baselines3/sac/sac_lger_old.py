...
class SAC_LGER(OffPolicyAlgorithm):
    """
    ...
    def _setup_model(self) -> None:
        super(SAC_LGER, self)._setup_model()
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        logger.record("train/buffer_size", self.replay_buffer.pos, exclude="tensorboard")
    ...
    def learn(
        ...
        tb_log_name: str = "SAC_LGER",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
        mode: str = "default",
    ) -> OffPolicyAlgorithm:

        return super(SAC_LGER, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(SAC_LGER, self)._excluded_save_params() + ["actor", "critic", "critic_target"]
